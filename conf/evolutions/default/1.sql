...
create table password_links (
  passwdlink                    varchar(255) not null,
  id                            varchar(255),
  constraint pk_password_links primary key (passwdlink)
);

create table post (
  id                            bigint not null,
  post_msg                      varchar(5000),
  post_type                     smallint,
  posted_on                     timestamp,
  user_id                       varchar(255),
  group_id                      integer,
...
drop table if exists password_links cascade;
