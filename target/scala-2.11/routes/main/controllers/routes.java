...
public class routes {
  ...
  public static final controllers.ReversePasswordResetController PasswordResetController = new controllers.ReversePasswordResetController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReversePasswordResetController PasswordResetController = new controllers.javascript.ReversePasswordResetController(RoutesPrefix.byNamePrefix());
